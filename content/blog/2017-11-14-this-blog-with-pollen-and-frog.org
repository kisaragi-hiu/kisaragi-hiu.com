...
/Update 2020-10-31T03:06:28+0900: this is now outdated. See [[2020-10-31-infrastructure.org][2020-10-31 Current infrastructure]] for further changes, including the move away from Frog and the introduction of ox-pollen./
...
In March this year, I discovered Github Pages, and wanted to revive my personal site. I started with the official tutorial, not understanding static site generators or Jekyll, even. I only wrote one post during this time, basically [[file:zh-new-website.org][the hello world post]].
...
When trying to customize and extend [[https://web.archive.org/web/20170708201545/https://mstill.io/][mstill.io]]'s system, I had no option but to learn how Malcolm Still has implemented it. This actually taught me a lot about how static site generators (generally) work: they take in source files, turn them into HTML, then combine them into templates. Previously I thought of templates as a black box, but now I see they're just combined together like a tree.
...
This is the trickest part for me. My web development experience only consisted of going through freeCodeCamp's first few turorials and modifying an already styled tenplate from [[https://web.archive.org/web/20170708201545/https://mstill.io/][mstill.io]].
...
In the end I spent two weeks from putting up an issue on the Github page to move away from Pollen, to having an overall better site (compared to the mess I added onto [[https://web.archive.org/web/20170708201545/https://mstill.io/][mstill.io]]'s basis) built on Frog, in two weeks time.
