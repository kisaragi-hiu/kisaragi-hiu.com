#lang pollen
    ...
    Tags: language:en, category:Tutorials, UTAU

In UTAU, labels are a simple way to mark sections of the UST to easily jump around. I've been using them to make notes in the UST since [my メリュー cover](https://www.youtube.com/watch?v=PNLT7WUuXHM), and for marking sections since [my 濫觴生命 cover](https://www.youtube.com/watch?v=3hnI8DqMVfc).

◊image["/images/utau/screenshot-labels.png" "Labels marking sections."]
...
◊image["/images/utau/screenshot-labels-set.png"]
...
◊image["/images/utau/screenshot-labels-change.png" "Move, Change label, and Remove label."]

## Example

◊image["/images/utau/screenshot-labels-usage.png" "My labels usage in the 濫觴生命 cover."]
