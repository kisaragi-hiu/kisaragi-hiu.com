...
◊; vim: filetype=pollen
    ...
    Tags: language:en, UTAU, Covers, Music, VOCALOID
...
The singing experiment last year ended pretty much as a failure, with only six covers released overall (so it wasn't even frequent), and my voice never improving during that time. I realized that I need to practice my voice, and that I do not have an environment that I'm comfortable to practice in. I decided to put it aside for now (I can pick it up in the future with more effort, if I want), and focus somewhere else instead.

So starting with ◊youtube["npl4XY7CwK4"]{my cover of SHIRO} in March, I started finding more songs to cover and trying out Yamine Renri's variants. While covering SHIRO, I tried to utilize Moresampler's flags (specifically `Mt`), which turned out pretty decent. With the next cover, ◊youtube["DpOt7wi-P7E"]{This Earth, for You ft. Yamine Renri}, I tried to put as much emotion into it as I can, utilizing Renri's variants and Moresampler's flags together, and I think it turned out alright. One big issue was my use of breath sounds — this cover was actually the first time I attached breath-in sounds to a cover, and I kind of screwed that up by making them too audible.
