...
◊(define (rant . text)
   (->html `(span ([style "color: #777;"]) "(" ,@text ")")))
...
◊series{Sukasuka} Series like this are why I love fantasy stories. I just love daydreaming in those wonderfully constructed worlds. The world Sukasuka takes place in is one that's actually quite hopeless, even compared to our own. This is the *stomach aching* series of Spring 2017.
...
◊series{Made in Abyss} Colwelela (Hanezeve yulu-mai) kalalila!
...
◊series{Fukumenkei Noise} This series aired while I was trying out practicing singing (which I currently put on hold), so it sort of grabbed my attention being a story around three people involved in music. ◊rant{I just noticed Yuzu goes by the same name as the protagonist in Citrus, how ◊s{wonderful}…}
...
◊series{Konosuba S2} Being one of the more well made comedy series of recent time (?), Konosuba doesn't really *need* a second season to be an enjoyable ride, but this season lives up to its promise. It really is quite fun to watch.
...
◊series{Kino's Journey (Kino no tabi)} Kino's Journey has always been its own weird beast that somehow works. The novel series has been going on for almost as long as I've lived…!
...
◊series{Girl's Last Tour (Shoujo Shuumatsu Ryokou)} Kino's Journey, Post-apocalyptic edition (?).
