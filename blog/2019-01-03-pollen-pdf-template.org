...
First was finding a programmable interface to render an HTML to PDF. I knew Chrom/ium has a ◊code{--print-to-pdf} option, but initially I thought it's going to have unavoidable headers and footers. So I started working with [[https://wkhtmltopdf.org/][◊command{wkhtmltopdf]]}.
