#lang pollen
◊define-meta[title]{Setting up this site with Pollen and Frog}
◊define-meta[date]{2017-11-14T10:56:43}
...
◊heading{First encounter with Frog, and my Pollen site based on mstill.io}
...
◊heading{Back to Frog, preprocessed with Pollen}
...
◊subheading{Choosing the static site generator}
...
◊subheading{Port over the posts, preprocess them with Pollen}
...
◊subheading{Dealing with Markdown newlines}
...
◊subheading{Figuring out the design}
...
◊heading{Extra: setting up Travis CI}
