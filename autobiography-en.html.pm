#lang pollen
◊define-meta[headline]{About Kisaragi Hiu}
◊(define osu (link "https://osu.ppy.sh/home" "osu!"))
◊(define hoshinonamida (noichigo "1393204" "星の涙"))

◊section{Past.}

I'm Kevin Shen, or Kisaragi Hiu, a 17-year-old third-grader in ◊link["http://www.slhs.tp.edu.tw/"]{Shilin High School of Commerce}.
...
◊subsection{Junier high}
I joined ◊link["https://web.dcsh.tp.edu.tw/"]{"Da Zhi High School"} in September.
...
I got a laptop from my family in October 2013, and immediately installed ◊link["https://elementary.io/"]{elementary OS} on it. After that was my time of rapid Linux exploration.
...
I publish my covers on ◊youtube["channel/UCl_hsqcvdX0XdgBimRQ6R3A"]{Youtube} and ◊niconico["user/38995186"]{niconico}, and my renders, sketches, etc. on ◊pixiv["member.php?id=14235181"]{Pixiv}.

◊pagebreak
◊subsection{Senior high}

I joined ◊link["http://www.slhs.tp.edu.tw/"]{Shilin High School of Commerce} in 2015, majoring in the Applied Foreign Language (English) department, with the goal of advancing my English skills.

I've translated a few projects in senior high so far. I am the main (only, actually) Chinese (Taiwan) translator for ◊link["https://easyrpg.org/"]{EasyRPG Player}, as you can see on ◊transifex["FlyingFeather"]{my Transifex profile}, and one of the three Traditional Chinese translators for ◊github["naseweis520/osu-Sync"]{osu!Sync}, a tool for managing ◊osuwiki["Beatmaps"]{osu! beatmaps}.
...
･Do basic programming (◊github["flyingfeather1501"]{See for yourself.})
･Blender
